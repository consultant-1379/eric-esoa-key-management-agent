 ...
 ******************************************************************************/
package com.ericsson.oss.sec.utils;
...
public final class ResourceLoaderUtils {
     ...
     *
     * @param path the path to the resource you want to load
     *
     * @return the loaded resource as an {@link InputStream}
     *
     * @throws IllegalArgumentException if the supplied path has no resource to load
     */
     ...
     *
     * @throws IllegalArgumentException if the supplied path has no resource to load
     * @throws IOException if there is any error loading the file or converting it
     */
