...
/**
 * NegativeUpdateCredentialNotAlreadyExistingBase
 */
@ExtendWith(MockitoExtension.class)
public class NegativeUpdateCredentialNotAlreadyExistingBase extends AllContractsBase {
    ...
    public void setup() {
        ...
        given(keyManagementService.getSecret(any())).willReturn(Optional.empty());
