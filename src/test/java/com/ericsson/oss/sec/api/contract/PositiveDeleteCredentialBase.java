...
/**
 * PositiveDeleteCredentialBase
 */
public class PositiveDeleteCredentialBase extends AllContractsBase {
    ...
    public void setup() {
        ...
        willDoNothing().given(keyManagementService).deleteSecret(any());
